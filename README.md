...
### 特性
  - 漫画浏览模式: 空格/单击左键跳到图片的下一个浏览区域(衔接上一区域，mm会一次到底), 鼠标滚轮上下移动图片，方向键上下左右移动图片, PageDown/Up翻页, Ctrl+End跳到尾页, Ctrl+PageUp/Down跳目录, +/-放大缩小图片，按住左键拖拽图片
...
2024/3/27 v2.8.170.0
- [bug]修正滑动条右边显示不全的问题
- [bug]滑动条在非全屏状态下没有画中间的白线
- 不维护密码处理
...
### 下载
  ...
  - github为唯一发布页，无任何推广, 觉得有帮助请点星，支持作者继续开发。
